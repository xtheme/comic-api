...
class CreateChannelMonthlyReportsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('channel_monthly_reports', function (Blueprint $table) {
            $table->integer('id')->autoIncrement();
            $table->integer('channel_id')->default(0)->comment('渠道代號');
            $table->date('date')->comment('日期 (月)');
    ...
    {
        Schema::dropIfExists('channel_monthly_reports');
    }
}
