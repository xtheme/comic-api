                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control image-path" name="cover" value="{{ $book->getRawOriginal('cover') }}" autocomplete="off">
                        ...
                        <div class="upload-image-callback">
                            @if($book->getRawOriginal('cover'))<img src="{{ $book->cover }}" width="300" alt="">@endif
                        </div>
                    </div>
                </div>
